...
<html lang="en">
  ...
  <body>
    ...
    <div class="dropdown-menu" aria-labelledby="dropdown04">
     ...
     <h1>Cảm ơn bạn đã mua hàng!Vui Lòng Bank Vào MoMo : 0385327560 ,để hoàn thành đơn hàng.</h1>
     </footer>
                ...
                <div class="ftco-footer-widget mb-4">
                    ...
                    <div class="block-23 mb-3">
                        <ul>
                            ...
                            <li><a href="#"><span class="icon icon-envelope"></span><span class="text">benvo1104202@gmail.com</span></a></li>
                        </ul>
                    </div>
                </div>
            </div>
